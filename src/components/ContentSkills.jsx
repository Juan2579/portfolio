...
export const ContentSkills = () => {
  return (
    <div className='w-full flex flex-col gap-4 lg:gap-7'>
      <h2 className='text-xl font-bold underline underline-offset-8 decoration-[#ed05f9] md:text-2xl lg:text-3xl lg:pt-16 xl:text-4xl'>Habilidades</h2>
      <div className='w-full h-auto flex flex-col lg:gap-4 lg:flex-row lg:items-start'>
        <div className='lg:w-full lg:flex lg:flex-col lg:gap-5'>
          <p className='text-gray-300 text-md pb-4 md:text-lg lg:text-xl lg:w-full xl:text-2xl'>
          ...
          <img className='hidden w-[500px] h-[300px] lg:inline-block lg:mx-auto' src="/public/assets/images/technologyIlustration.png" alt="" />
        </div>
        <ul className='w-full h-auto flex justify-center items-center flex-wrap gap-3 lg:pb-32'>
          {technologies.map((technology) => {
            return (
              <li className='technology-shadow w-32 h-40 relative flex flex-col gap-1 justify-center items-center bg-[#310a51] rounded-lg z-10 transition-all duration-500 opacity-100 md:w-36 md:h-44 md:hover:scale-110 md:hover:mx-6'>
