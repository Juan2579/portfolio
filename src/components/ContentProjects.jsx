...
export const ContentProjects = () => {
  ...
  return (
    <div className='w-full flex flex-col gap-8 lg:gap-7'>
      <h2 className='text-xl font-bold underline underline-offset-8 decoration-[#ed05f9] pl-8 lg:pl-0 md:text-2xl  lg:text-3xl lg:pt-8 xl:pt-12 xl:text-4xl'>Proyectos</h2>
      <ul className='w-full flex items-center justify-center flex-wrap gap-7 px-5 lg:px-0'>
        {projects.map((project) => {
          return (
            <li className='max-w-[450px] h-auto flex flex-col items-center bg-[#0e0d10] gap-3 py-4 px-3 bg-clip-padding bg-opacity-40 rounded-xl shadow-2xl md:max-w-[350px] lg:max-w-[450px] lg:min-h-[540px] lg:gap-5 xl:min-h-[560px] 2xl:max-w-[450px] 2xl:min-h-[530px]'  style={{backdropFilter: "blur(5px)"}}>
